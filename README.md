...
* A big part of the project is a filebrowser API that is use by the GUI library to graphically choose a Light-scene from the SD-Card. ![asd](images/20181218_173306.jpg)
* In the Main Window the Lights can be controlled, like Fading, Music Control, Brightness and Speed. ![asd](images/20181218_173355.jpg)
